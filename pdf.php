...
window.open('profile2.php','_self');
</script>
<?php 
   }
...
<!-- <div class="social">
              ...
              <button type="button"><a class='north' href="#" title="Download .pdf"><img src="images/icn-save.jpg" alt="Download the pdf version" /></a></button>
</ul>
</div> -->
